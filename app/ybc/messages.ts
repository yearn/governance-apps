export const ybcCopy = {
  ...
  shell: {
    ...
    body:
      "WP2, WP3, and WP5 fill the overview, member roster, proposal board, and scoped operator panel while the approved rewards section remains a mapped shell for a later work package.",
