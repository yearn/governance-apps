...
export const daoCopy = {
  ...
  detail: {
    ...
    ruleLabels: {
      ...
      executionGuard: "Execution access",
      votingContract: "Voting contract",
      observationBlock: "Configuration observed at block",
    },
    thresholdOfVotesCast: (threshold: string) => `${threshold} of votes cast`,
    durationDays: (days: number) => `${days} ${days === 1 ? "day" : "days"}`,
    durationHours: (hours: number) =>
      `${hours} ${hours === 1 ? "hour" : "hours"}`,
    guardedExecution: "Guarded execution",
    permissionlessExecution: "Permissionless execution",
    ...
    eventBlockHash: "Block hash",
    eventBlockTime: "Block time",
    eventTransactionIndex: "Transaction index",
    eventLogIndex: "Log index",
