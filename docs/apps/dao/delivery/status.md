...
- Current milestone: M2 in progress; WP4 accepted
- Next package: M2 WP6
...
| M2 mock UX | In progress | WP4 proposal board and detail accepted; WP6, WP5, and WP7 remain | Continue the documented M2 sequence, then stop for user review |
