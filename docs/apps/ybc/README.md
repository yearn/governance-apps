...
The current mock-backed route integrates the accepted WP2, WP3, and WP5 prototypes:
...
Reward handoff remains visible as a mapped shell section until a later work package
implements its interactive depth.
