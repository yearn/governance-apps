...
type LogoYearnProps = React.SVGProps<SVGSVGElement> & {
  back?: string;
  front?: string;
...
export function LogoYearn(
  { back = "text-neutral-900", front = "text-neutral-900", gradient, ...svgProps }: LogoYearnProps,
) {
  const gradientId = `logo-yearn-gradient-${React.useId().replace(/:/g, "")}`;
  ...
  return (
    ...
    >
      ...
      <circle
        ...
        className={!gradient ? back : undefined}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
